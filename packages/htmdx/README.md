...
```bash
npx @wix/htmdx@4.9.0 lint docs/*.htmdx --strict
npx @wix/htmdx@4.9.0 compile report.htmdx --out report-body.html
npx @wix/htmdx@4.9.0 components Callout
npx @wix/htmdx@4.9.0 skill
```
...
```bash
npx @wix/htmdx@4.9.0 skill                 # authoring guidance
npx @wix/htmdx@4.9.0 skill --list          # available topics
npx @wix/htmdx@4.9.0 skill components      # body grammar per component

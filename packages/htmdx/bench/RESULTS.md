...
| --- | ---: | ---: | ---: | ---: | ---: |
| htmdx source | 950 | x1.00 | 834 | 133 | 3797 |
| compiled HTML (`compile()`) | 4045 | x4.26 | 3953 | 502 | 14892 |
...
| Format | Artifact tokens | vs htmdx | Payload tokens | Edit tokens (3 tasks) | Artifact chars |
| --- | ---: | ---: | ---: | ---: | ---: |
| htmdx source | 853 | x1.00 | 734 | 64 | 4095 |
| compiled HTML (`compile()`) | 3720 | x4.36 | 3625 | 172 | 14253 |
...
| Task | htmdx | compiled | hand | jsx | md |
| --- | ---: | ---: | ---: | ---: | ---: |
| update-savings | 14 | 30 | 16 | 16 | 12 |
| add-callout | 40 | 120 | 105 | 66 | 47 |
...
| Task | Needs | `components.json` | `htmdx components` | `htmdx components --used` |
| --- | --- | ---: | ---: | ---: |
| `update-metric` | — | 13634 = **13634** | 1600 = **1600** | 1576 = **1576** |
| `add-badge` | Badge | 13634 = **13634** | 1600 +52 = **1652** | 1576 = **1576** |
| `add-accordion-item` | AccordionContent, AccordionItem, AccordionTrigger | 13634 = **13634** | 1600 +257 = **1857** | 1576 = **1576** |
| `add-risk-table` | RiskTable | 13634 = **13634** | 1600 +94 = **1694** | 1576 +94 = **1670** |

### Executive Decision Report: Support Platform Consolidation

| Task | Needs | `components.json` | `htmdx components` | `htmdx components --used` |
| --- | --- | ---: | ---: | ---: |
| `update-savings` | — | 13634 = **13634** | 1600 = **1600** | 539 = **539** |
| `add-callout` | Callout | 13634 = **13634** | 1600 +50 = **1650** | 539 = **539** |
| `change-date` | — | 13634 = **13634** | 1600 = **1600** | 539 = **539** |
| `add-data-table` | DataTable | 13634 = **13634** | 1600 +78 = **1678** | 539 +78 = **617** |
...
- **Checkout Migration — Decision Brief** — on `add-risk-table`, `--used` costs 1670 against 1694 for the list that also discovers: a 1.4% saving.
- **Executive Decision Report: Support Platform Consolidation** — on `add-data-table`, `--used` costs 617 against 1678 for the list that also discovers: a 63.2% saving.
...
| compiled HTML (`compile()`) | x4.26 | x4.27 | x4.36 | x4.36 |
...
- Without a hosting platform, JSX stops being one file: shadcn/ui components
  ...
  measure 3090 tokens in this repo's copies alone, before any

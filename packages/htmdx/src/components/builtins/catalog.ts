...
import { card, callout, executiveSummary, sourceQuote } from './markdown';
...
export const builtInReactComponents = Object.fromEntries(
  builtInComponents.map(({ name, component }) => [name, component]),
);
